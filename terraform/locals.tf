locals  {
    ...
    function_subnet_iprange="10.1.1.0/24"
    data_subnet_iprange="10.1.2.0/24"
    function_se_subnet="function-se"
    function_se_subnet_iprange="10.1.4.0/24"
    ...
    dns_nuget_application_rule_collection="nuget_rule_collection"
    dns_nuget_application_rule="nuget_rule"

    function_sites_private_link="${var.prefix}-function-private-link"
    function_sites_private_endpoint="${var.prefix}-function-private-endpoint"
    function_sites_dns_zone="privatelink.azurewebsites.net"
    function_sites_dns_link_spoke="${var.prefix}-function-dns-spoke-link"
    function_sites_dns_link_hub="${var.prefix}-function-dns-hub-link"

    storage_blob_dns_zone="privatelink.blob.core.windows.net"
    storage_data_blob_private_link="${var.prefix}-blob-private-link"
    storage_data_blob_private_endpoint="${var.prefix}-storage-blob-private-endpoint"
    storage_data_blob_dns_link_spoke="${var.prefix}-storage-blob-dns-spoke-link"
    storage_data_blob_dns_link_hub="${var.prefix}-storage-blob-dns-hub-link"
